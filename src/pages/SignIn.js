...
const SignIn = () => {
  return (
    <div className="w-[100vw] h-[100vh] flex items-center justify-center flex-col bg-slate-200 dark:bg-slate-900 text-slate-100">
      <h1 className="px-3 mb-4 text-3xl font-bold ">Cześć</h1>
      <button
        type="button"
